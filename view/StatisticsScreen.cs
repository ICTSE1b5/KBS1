...
namespace KBS1.view
{
    public partial class StatisticsScreen : UserControl
    {
        ...
        public void DrawPanel2(List<GameObject> gameobjects)
        {
            foreach (GameObject item in gameobjects)
            {
                List<Panel> panelList = new List<Panel>();
                int x = 0;
                string s1 = "X = " + item.GetProperty(GameObject.ObjectProperties.Position_X);
                string s2 = "Y = " + item.GetProperty(GameObject.ObjectProperties.Position_Y);
                string s3 = "Speed = " + item.GetProperty(GameObject.ObjectProperties.Speed_X);
